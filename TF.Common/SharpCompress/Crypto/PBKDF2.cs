using TF.Common.BouncyCastle.Crypto;
using TF.Common.BouncyCastle.Crypto.Digests;
using TF.Common.BouncyCastle.Crypto.Macs;
using TF.Common.BouncyCastle.Crypto.Parameters;
using System;

namespace TF.Common.SharpCompress.Crypto
{
    //Gathered from:
