...
namespace TF.Common.SharpCompress.Compressor.PPMd.H
{
    internal class SubAllocator
    {
        ...
        //UPGRADE_NOTE: The initialization of  'UNIT_SIZE' was moved to static method 'TF.Common.SharpCompress.Unpack.PPM.SubAllocator'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
