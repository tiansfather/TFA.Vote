...
using TF.Common.SharpCompress.Compressor.LZMA;
using TF.Common.SharpCompress.Compressor.PPMd;
using TF.Common.SharpCompress.IO;
using System;
using System.Collections.Generic;
using System.IO;
using System.Text;
using DeflateStream = TF.Common.SharpCompress.Compressor.Deflate.DeflateStream;

namespace TF.Common.SharpCompress.Writer.Zip
{
